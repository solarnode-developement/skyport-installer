# :bird: skyport-installer

[![Discord](https://img.shields.io/discord/682342331206074373?label=&logo=discord&logoColor=ffffff&color=7389D8&labelColor=6A7EC2)](https://discord.gg/BW6qNVKyZ2)
...
Unofficial scripts for installing Skyport Panel & Daemon. Works with the latest version of Skyport!
...
For help and support regarding the script itself and **not the official Skyport project**, you can join the [Discord Chat](https://discord.gg/BW6qNVKyZ2).
...
```bash
bash <(curl -s https://raw.githubusercontent.com/solarnode-developement/skyport-installer/main/install_skyport.sh)
```
...
- Created by [Ismam Ilahi](https://github.com/ismamilahi)
- Maintained by [Ismam Ilahi](https://github.com/ismamilahi)
